...
class TaskRepository {
  static List<Task> tasks = [
    Task(title: "Projekt Flutter", deadline: "jutro", done: false),
    Task(title: "Oddać raport", deadline: "dzisiaj", done: true),
    Task(title: "Powtórzyć widgety", deadline: "w piątek", done: true),
